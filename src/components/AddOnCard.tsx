...
const AddOnCard = ({ name, addonPrice, standalonePrice, description, icon, onSelect }: AddOnCardProps) => {
  return (
    <div className="bg-white rounded-2xl p-5 shadow-warm flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-warm-lg">
