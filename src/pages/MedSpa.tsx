    ...
    <div className="min-h-screen bg-[hsl(40,5%,8%)] text-[hsl(40,20%,90%)]">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-[hsl(40,10%,60%)] max-w-2xl mx-auto mb-10 leading-relaxed font-['Inter',sans-serif]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              to="/portfolio"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-[hsl(40,15%,25%)] hover:border-[hsl(40,30%,45%)] text-[hsl(40,20%,90%)] font-semibold tracking-wide uppercase text-sm transition-all hover:-translate-y-0.5 font-['Inter',sans-serif]"
            >
